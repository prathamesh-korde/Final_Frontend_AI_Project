...
const SuperAdminHeader = ({ onMenuToggle }) => {
  ...
  const getNavTitle = () => {
    ...
    if (path.includes("/EnquiryMessages")) return "Enquiry Messages";
    if (path.includes("/CompaniesRegister")) return "Register Companies";
    if (path.includes("/RejisteredRecruiters")) return "Recently Applied";
