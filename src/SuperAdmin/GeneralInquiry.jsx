...
import { Mail, Send, CheckCircle, AlertCircle, User, Phone, Building2, Users } from 'lucide-react';
...
const GeneralInquiry = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setFormData({
          ...
          phone: '', companyName: '', companySize: '', message: ''
        });
      }, 3500);
    }, 2000);
  };
  ...
  const inputBase =
    'w-full px-4 py-2.5 text-sm text-gray-800 bg-gray-50 border rounded-lg outline-none transition-all duration-200 placeholder:text-gray-400 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100';
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 w-full max-w-2xl overflow-hidden">
        ...
        <div className="bg-blue-600 px-8 py-7">
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-xl font-semibold text-white">General Inquiry</h1>
          </div>
          <p className="text-blue-100 text-sm pl-11">
            Have a question? Fill out the form and we'll be in touch shortly.
          </p>
        </div>
        ...
        <div className="px-8 py-8">
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div className="border-t border-gray-100 pt-4">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 active:scale-[0.99] text-white text-sm font-medium py-3 px-6 rounded-lg transition-all duration-150 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            ...
            <span className="underline cursor-pointer hover:text-blue-600 transition-colors">Privacy Policy</span>
            {' '}and{' '}
            <span className="underline cursor-pointer hover:text-blue-600 transition-colors">Terms of Service</span>.
          </p>
        </div>
      </div>
    </div>
